...
<link href="http://103.16.141.79:8185/Realgames/css/bootstrap.min.css" rel="stylesheet">
<link href="http://103.16.141.79:8185/Realgames/css/font-awesome.css" rel="stylesheet">
<link href="http://103.16.141.79:8185/Realgames/css/owl.carousel.css" rel="stylesheet">
<link href="http://103.16.141.79:8185/Realgames/css/style.css" rel="stylesheet">
<link href="http://103.16.141.79:8185/Realgames/css/roboto.css" rel="stylesheet">
<link rel="shortcut icon" href="" 
      type="http://real4games.in/image/vnd.microsoft.icon"/>

 <link type="text/css" rel="stylesheet" href="http://103.16.141.79:8185/Realgames/css/style.css" media="screen" />
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<script src="http://103.16.141.79:8185/Realgames/js/real.js"></script>
<script async src="http://real4games.in/pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
  <!--<script src="//ajax.googleapis.com/ajax/libs/jquery/2.0.2/jquery.min.js"></script>-->
<script src="http://103.16.141.79:8185/Realgames/js/jquery-1.11.3.min.js"></script>
<script src="http://103.16.141.79:8185/Realgames/js/bootstrap.min.js"></script>
<script src="http://103.16.141.79:8185/Realgames/js/owl.carousel.min.js"></script>
<script src="http://103.16.141.79:8185/Realgames/js/readmore.js"></script>
<script src="http://103.16.141.79:8185/Realgames/js/custom.js"></script>
...
<body>
  ...
  <div class="header-left" style="background-color:#008275">
   ...
   <ul class="dropdown-menu" style="background-color:#74dbe0 ">
      <li><a href="./ContentDetail.jsp" alt="Action">Action</a></li>
      <li><a href="./ContentDetail.jsp" alt="Adventure">Adventure</a></li>
      <li><a href="./ContentDetail.jsp" alt="Arcade">Arcade</a></li>
      <li><a href="./ContentDetail.jsp" alt="Arcade">Board Games</a></li>
      <li><a href="./ContentDetail.jsp">Brain Games</a></li>
      <li><a href="./ContentDetail.jsp">Card Games</a></li>
      <li><a  href="./ContentDetail.jsp">Casino</a></li>
      <li><a href="./ContentDetail.jsp">Casual</a></li>
      <li><a href="./ContentDetail.jsp" alt="Adventure">Girls</a></li>
      <li><a href="./ContentDetail.jsp" alt="Arcade">Kids</a></li>
      <li><a href="./ContentDetail.jsp" alt="Arcade">Puzzle</a></li>
      <li><a href="./ContentDetail.jsp">Racing</a></li>
      <li><a href="./ContentDetail.jsp">Shooting</a></li>
      <li><a  href="./ContentDetail.jsp">Sports</a></li>
      <li><a href="./ContentDetail.jsp">Strategy</a></li>
 </ul>
             </li>
...
<form action="ContentDetail.jsp" method="POST">
    ...
    <a  href="http://203.115.105.98:7070/html5webservice/games/BlockTower/index.html"  style="background-color:#adc9f7;"><img src="http://13.58.181.12/jcmsv3/AnomanETH/images/Dingo_dragon.png"  class="img-responsive" /></a>
</form>
</div>
...
<form action="ContentDetail.jsp" method="POST">
    ...
    <a  href="http://203.115.105.98:7070/html5webservice/games/Bubbleblow/index.html"  style="background-color:#adc9f7;"><img src="http://13.58.181.12/jcmsv3/AnomanETH/images/Bubble_blow.PNG"  class="img-responsive" /></a>
</form>
</div>
...
<form action="ContentDetail.jsp" method="POST">
    ...
    <a  href="http://203.115.105.98:7070/html5webservice/games/Bubbleblow/index.html"  style="background-color:#adc9f7;"><img src="http://13.58.181.12/jcmsv3/AnomanETH/images/dark_village.PNG"  class="img-responsive" /></a>
</form>
</div>
...
<form action="ContentDetail.jsp" method="POST">
    ...
    <a  href="http://203.115.105.98:7070/html5webservice/games/CatReaction/index.html"  style="background-color:#adc9f7;"><img src="http://13.58.181.12/jcmsv3/AnomanETH/images/bird_copter.PNG"  class="img-responsive" /></a>
</form>
</div>
...
<!--//------------------buttonsend-------------------->
 ...
 <div class="grayBg"  style="background-color:#ccfffb;"  style="background-color:#ccfffb;">
  <div class="head-blk" style="background-color:#02f2e2; border-style: inset ;">
    <div class="left-text">
      <h4 style="color:#028704;" >New and Updated Game</h4>
          </div>
  ...
  <ul class="list-grid" >
    <div class="owl-carousel owl-example">
			 ...
			 <div class="item item-center" >
                         ...
                         <a  href="#"  style="background-color:#adc9f7;"><img src="http://tapcubestudios.com/rnpl/tcs129/thumb.png"  height="85" width="85"/><h5 >Lucky Wheels</h5><span class="green" >3.8 &#9733 </span></a>
                         </form>
			</li>
			 </div>
			 ...
			 <div class="item item-center">
                         ...
                         <a  href="#"  style="background-color:#adc9f7;"><img src="http://tapcubestudios.com/rnpl/tcs133/thumb.png" height="85" width="85"/><h5>Pancake Pile Up</h5><span class="green">4.5 &#9733 </span></a>
                         </form>
			</li>
			 </div>
			 ...
			 <div class="item item-center">
                         ...
                         <a  href="#"  style="background-color:#adc9f7;"><img src="http://tapcubestudios.com/rnpl/tcs142/thumb.png" height="85" width="85"/><h5>Shoot Zombies</h5><span class="green">4.3 &#9733 </span></a>
                         </form>
			</li>
			 </div>
			 ...
			 <div class="item item-center">
                         ...
                         <a  href="#"  style="background-color:#adc9f7;"><img src="http://tapcubestudios.com/rnpl/tcs134/thumb.png" height="85" width="85"/><h5>Pin Cracker</h5><span class="green">4.1 &#9733 </span></a>
                         </form>
			</li>
			 </div>
			 ...
			 <div class="item item-center">
                         ...
                         <a  href="#"  style="background-color:#adc9f7;"><img src="http://tapcubestudios.com/rnpl/tcs140/thumb.png" height="85" width="85"/><h5>Rail Rush</h5><span class="green">4.4 &#9733 </span></a>
                         </form>
			</li>
			 </div>
...
<banner><img src="http://13.58.181.12/jcmsv3/AnomanETH/images/bottal_blast.png"></banner></a>
</form>
<!--//--------------end of banner1-------------------->
